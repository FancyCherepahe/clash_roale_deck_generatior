...
generateButton.addEventListener("click", function() {
    //That part of the code hide text and emote and show cards
    ...
    // That part of code all card in clash royale
    const buildings = [
...
//Calculate avareage elixir cost
